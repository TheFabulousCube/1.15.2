		...
		for (Biome biome : ForgeRegistries.BIOMES) {
	        ...
	        LOGGER.info("HELLO from World Gen 4" + x4Config.config.toString());
				...
				biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Feature.ORE
					.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, BlockInit.x2block_mixed.getDefaultState(), 27))
					.withPlacement(x2Config));
		        LOGGER.info("HELLO from World Gen x2s added");
		        
				biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Feature.ORE
						.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, BlockInit.x3block_mixed.getDefaultState(), 20))
						.withPlacement(x3Config));
		        LOGGER.info("HELLO from World Gen x3s added");
		        		
				biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Feature.ORE
						.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, BlockInit.x4block_mixed.getDefaultState(), 16))
