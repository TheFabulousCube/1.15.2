...
public class CubeSoundTypes {
	...
	public static final SoundType CUBE = new SoundType(0.8F, 1.0F, SoundInit.BLOCK_CUBE_BREAK,
			SoundInit.BLOCK_CUBE_STEP, SoundInit.BLOCK_CUBE_PLACE, SoundInit.BLOCK_CUBE_HIT, SoundInit.BLOCK_CUBE_FALL);
